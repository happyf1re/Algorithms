...
public class MyTreeMap<K extends Comparable<K>, V> {
    ...
    private class Node {
        ...
        //Добавить поле height которое хранит высоту данного узла.
        int height;
    ...
    //Добавить закрытый и открытый метод size()
    public int height() {
        return height(root);
    }
    ...
    private int height(Node node) {
        ...
        //если нет наследников, то нет и рёбер
        if (node.left == null && node.right == null) {
            return 0;
        }

        if(node.left == null) {
            // +1 - это высота самого узла
